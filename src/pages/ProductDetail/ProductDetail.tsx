...
function ProductDetail() {
  ...
  return (
    <div className='bg-gray-200 py-6'>
        ...
        <div className='bg-white p-4 shadow'>
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              <h2 className='text-xm font-medium uppercase '>{product.name}</h2>
              <div className='mt-8 flex items-center'>
                ...
                <div>
                  ...
                  <span className='ml-1 text-gray-500'>{t('product details.sold')}</span>
                </div>
              </div>
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                ...
                <div className='ml-4 rounded-sm bg-orange px-1 py-[2px] text-xs font-semibold uppercase text-white'>
                  {rateSale(product.price_before_discount, product.price)} {t('product details.Off')}
                </div>
              </div>
              <div className='mt-8 flex items-center'>
                ...
                <div className='ml-6 text-sm text-gray-500'>
                  {product.quantity} {t('product details.available')}
                </div>
              </div>
              <div className='mt-8 flex items-center'>
                <button
      ...
      <div className='mt-8'>
        <div className='container'>
          <div className='uppercase text-gray-400'>{t('product details.canbe')}</div>
          {productsData && (
